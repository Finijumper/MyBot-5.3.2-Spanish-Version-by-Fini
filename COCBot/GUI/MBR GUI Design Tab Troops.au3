...
;	;$y =464
;	$grpMods = GUICtrlCreateGroup("Spell Factory Options", $x - 20, $y + 2, 150, 39)
;		$y += 15
...
;	GUICtrlCreateGroup("", -99, -99, 1, 1)
	...
	$grpOtherTroops = GUICtrlCreateGroup(GetTranslated(1,44, "Add. Troops"), $x - 20, $y - 20, 145, 195)
		...
		$txtNumGiant = GUICtrlCreateInput("0", $x + 80, $y - 3, 30, -1, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER))
		...
		$txtNumWall = GUICtrlCreateInput("0", $x + 80, $y - 3, 30, -1, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER))
